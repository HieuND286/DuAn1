...
public class DonGiao_VM_1 {
    ...
    public DonGiao_VM_1(String idDG, String idHD, String hoTenNguoiNhan, String sdtNguoiNhan, String hoTenShipper, String sdtShipper, String ngayGiao, String ngayNhan, String diaChi, int trangThai) {
        this.idDG = idDG;
        this.idHD = idHD;
