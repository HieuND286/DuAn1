 ...
 * @author Acer
 */
public class FrameDonGiao extends javax.swing.JFrame {
 ...
 private void clear() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDonGiao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDonGiao().setVisible(true);
            }
        });
    }
