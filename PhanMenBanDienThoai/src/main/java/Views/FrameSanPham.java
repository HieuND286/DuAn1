...
public class FrameSanPham extends javax.swing.JFrame {
    ...
    private SanPham_VM sanPham_VM;

    private FrameSanPham() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public SanPham_VM getSanPham_VM() {
        return sanPham_VM;
    }

    public void setSanPham_VM(SanPham_VM sanPham_VM) {
        this.sanPham_VM = sanPham_VM;
    }

    private FrameQuanLySanPham frameGOc;

    public FrameSanPham(FrameQuanLySanPham quanLySanPham) {
        initComponents();
    ...
    private void loadTableDelete() {
        ...
        dtm.setRowCount(0);
        List<SanPham_VM> list = this.sanPhamServive.getAllDelete();
        for (SanPham_VM sanPham_VM : list) {
            Object[] row = {
                sanPham_VM.getStt(),
                sanPham_VM.getMaSP(),
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        SanPham_VM sanPham_VM = this.data();
        int them = this.sanPhamServive.xoaTT(sanPham_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
        }
        frameGOc.loadComBoBoxSP();
        loadTable();
        loadTableDelete();
        clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        SanPham_VM sanPham_VM = this.data();
        int them = this.sanPhamServive.sua(sanPham_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        SanPham_VM sanPham_VM = this.data();
        int them = this.sanPhamServive.them(sanPham_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void tblxoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblxoaMouseClicked
        ...
        List<SanPham_VM> list = this.sanPhamServive.getAllDelete();
        for (SanPham_VM sanPham_VM : list) {
            if (sanPham_VM.getMaSP().equals(ma)) {
                id = sanPham_VM.getIdSP();
            }
        }

       SanPham_VM sanPham_VM = new SanPham_VM(row, id, ma, ten);
        this.setSanPham_VM(sanPham_VM);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int them = this.sanPhamServive.hoanLai(this.getSanPham_VM());
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        SanPham_VM sanPham_VM = this.data();
        int them = this.sanPhamServive.xoa(sanPham_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private SanPham_VM data() {
        ...
        SanPham_VM sanPham_VM1 = new SanPham_VM(WIDTH, id, ma, ten);
        return sanPham_VM1;
    }
