...
public class QuanLySanPham extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tblSanPhamCT.getColumnModel().getColumnCount() > 0) {
            tblSanPhamCT.getColumnModel().getColumn(0).setPreferredWidth(20);
            tblSanPhamCT.getColumnModel().getColumn(1).setMinWidth(0);
            tblSanPhamCT.getColumnModel().getColumn(1).setPreferredWidth(100);
            tblSanPhamCT.getColumnModel().getColumn(1).setMaxWidth(150);
            tblSanPhamCT.getColumnModel().getColumn(3).setPreferredWidth(200);
            tblSanPhamCT.getColumnModel().getColumn(4).setPreferredWidth(50);
            tblSanPhamCT.getColumnModel().getColumn(5).setPreferredWidth(30);
            tblSanPhamCT.getColumnModel().getColumn(6).setPreferredWidth(30);
            tblSanPhamCT.getColumnModel().getColumn(8).setPreferredWidth(100);
        }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(manHinh, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if (tblSanPhamCTNB.getColumnModel().getColumnCount() > 0) {
            tblSanPhamCTNB.getColumnModel().getColumn(0).setPreferredWidth(20);
            tblSanPhamCTNB.getColumnModel().getColumn(1).setMinWidth(0);
            tblSanPhamCTNB.getColumnModel().getColumn(1).setPreferredWidth(100);
            tblSanPhamCTNB.getColumnModel().getColumn(1).setMaxWidth(150);
            tblSanPhamCTNB.getColumnModel().getColumn(3).setPreferredWidth(200);
            tblSanPhamCTNB.getColumnModel().getColumn(4).setPreferredWidth(50);
            tblSanPhamCTNB.getColumnModel().getColumn(5).setPreferredWidth(30);
            tblSanPhamCTNB.getColumnModel().getColumn(6).setPreferredWidth(30);
            tblSanPhamCTNB.getColumnModel().getColumn(8).setPreferredWidth(100);
        }
   ...
   public void loadComBoBoxCPU() {
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        pin.setVisible(true);    }//GEN-LAST:event_jButton17ActionPerformed
