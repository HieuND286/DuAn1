...
import Repository.impl.HangRepo;
...
public class FrameHang extends javax.swing.JFrame {

    private HangServive hangServive = new HangServive();
    private Hang_VM hang_VM;

    private FrameHang() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public Hang_VM getHang_VM() {
        return hang_VM;
    }

    public void setHang_VM(Hang_VM hang_VM) {
        this.hang_VM = hang_VM;
    }

    private FrameQuanLySanPham frameGOc;

    public FrameHang(FrameQuanLySanPham quanLySanPham) {
        initComponents();
    ...
    private void loadTableDelete() {
        ...
        dtm.setRowCount(0);
        List<Hang_VM> list = this.hangServive.getAllDelete();
        for (Hang_VM hang_VM : list) {
            Object[] row = {
                hang_VM.getStt(),
                hang_VM.getMaHang(),
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Hang_VM hang_VM = this.data();
        int them = this.hangServive.xoaTT(hang_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
        }
        frameGOc.loadComBoBoxhang();
        loadTable();
        loadTableDelete();
        clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Hang_VM hang_VM = this.data();
        int them = this.hangServive.sua(hang_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Hang_VM hang_VM = this.data();
        int them = this.hangServive.them(hang_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void tbl1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl1MouseClicked
        ...
        List<Hang_VM> list = this.hangServive.getAllDelete();
        for (Hang_VM hang_VM : list) {
            if (hang_VM.getMaHang().equals(ma)) {
                id = hang_VM.getIdHang();
            }
        }
        Hang_VM hang_VM = new Hang_VM(row, id, ma, ten);
        this.setHang_VM(hang_VM);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        Hang_VM hang_VM = this.getHang_VM();
        int them = this.hangServive.hoanLai(hang_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private Hang_VM data() {
        ...
        Hang_VM hang_VM = new Hang_VM(WIDTH, id, ma, ten);
        return hang_VM;
    }
