...
public class FrameCPU extends javax.swing.JFrame {

    private CPUServive cPUServive = new CPUServive();
    private CPU_VM cpu_vm;

    private FrameCPU() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public CPU_VM getCpu_vm() {
        return cpu_vm;
    }

    public void setCpu_vm(CPU_VM cpu_vm) {
        this.cpu_vm = cpu_vm;
    }
    private FrameQuanLySanPham frameGOc;

    public FrameCPU(FrameQuanLySanPham quanLySanPham) {
        initComponents();
    ...
    private void loadTableDelete() {
        ...
        dtm.setRowCount(0);
        List<CPU_VM> list = this.cPUServive.getAllDeleteCpus();
        for (CPU_VM cpu_vm : list) {
            Object[] row = {
                cpu_vm.getStt(),
                cpu_vm.getMaCPU(),
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        CPU_VM cpu_vm = this.data();
        int them = this.cPUServive.xoaTT(cpu_vm);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
        }
        frameGOc.loadComBoBoxCPU();
        loadTable();
        loadTableDelete();
        clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        CPU_VM cpu_vm = this.data();
        int them = this.cPUServive.sua(cpu_vm);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        CPU_VM cpu_vm = this.data();
        int them = this.cPUServive.them(cpu_vm);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void tbl1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl1MouseClicked
        ...
        String id = null;
        List<CPU_VM> list = this.cPUServive.getAllDeleteCpus();
        for (CPU_VM cpu_vm1 : list) {
            if (cpu_vm1.getMaCPU().equals(ma)) {
                id = cpu_vm1.getIdCPU();
            }
        }
        CPU_VM cpu_vm = new CPU_VM(0, id, ma, ten);
        this.setCpu_vm(cpu_vm);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        CPU_VM cpu_vm = this.getCpu_vm();
        int them = this.cPUServive.hoanLai(cpu_vm);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        CPU_VM cpu_vm = this.getCpu_vm();
        int them = this.cPUServive.xoa(cpu_vm);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private CPU_VM data() {
        ...
        CPU_VM cpu_vm = new CPU_VM(WIDTH, id, ma, ten);
        return cpu_vm;
    }
