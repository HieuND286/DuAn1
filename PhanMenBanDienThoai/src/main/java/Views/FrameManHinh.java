...
public class FrameManHinh extends javax.swing.JFrame {
    ...
    private ManHinh_VM manHinh_VM;

    private FrameManHinh() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    } 

    public ManHinh_VM getManHinh_VM() {
        return manHinh_VM;
    }

    public void setManHinh_VM(ManHinh_VM manHinh_VM) {
        this.manHinh_VM = manHinh_VM;
    }
    
    private FrameQuanLySanPham frameGOc;

    public FrameManHinh(FrameQuanLySanPham quanLySanPham) {
        initComponents();
    ...
    private void loadTableDelete() {
        ...
        dtm.setRowCount(0);
        List<ManHinh_VM> list = this.manHinhServive.getAllDelete();
        for (ManHinh_VM manHinh_VM : list) {
            Object[] row = {
                manHinh_VM.getStt(),
                manHinh_VM.getMaMH(),
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ManHinh_VM manHinh_VM = this.data();
        int them = this.manHinhServive.xoaTT(manHinh_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
        }
        frameGOc.loadComBoBoxMH();
        loadTable();
        loadTableDelete();
        clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ManHinh_VM manHinh_VM = this.data();
        int them = this.manHinhServive.sua(manHinh_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ManHinh_VM manHinh_VM = this.data();
        int them = this.manHinhServive.them(manHinh_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void tbl1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl1MouseClicked
        ...
        List<ManHinh_VM> list = this.manHinhServive.getAllDelete();
        for (ManHinh_VM manHinh_VM : list) {
            if (manHinh_VM.getMaMH().equals(ma)) {
                id = manHinh_VM.getIdMH();
            }
        }
        ManHinh_VM manHinh_VM = new ManHinh_VM(row, id, ma, ten);
        this.setManHinh_VM(manHinh_VM);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int them = this.manHinhServive.hoanLai(this.getManHinh_VM());
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int them = this.manHinhServive.xoa(this.getManHinh_VM());
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private ManHinh_VM data() {
        ...
        ManHinh_VM manHinh_VM = new ManHinh_VM(WIDTH, id, ma, ten);
        return manHinh_VM;
    }
