...
public class FrameMauSac extends javax.swing.JFrame {
    ...
    private MauSac_VM mauSac_VM;

    private FrameMauSac() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public MauSac_VM getMauSac_VM() {
        return mauSac_VM;
    }

    public void setMauSac_VM(MauSac_VM mauSac_VM) {
        this.mauSac_VM = mauSac_VM;
    }

    private FrameQuanLySanPham frameGOc;

    public FrameMauSac(FrameQuanLySanPham quanLySanPham) {
        initComponents();
    ...
    private void loadTableDelete() {
        ...
        dtm.setRowCount(0);
        List<MauSac_VM> list = this.mauSacServive.getAllDelete();
        for (MauSac_VM mauSac_VM : list) {
            Object[] row = {
                mauSac_VM.getStt(),
                mauSac_VM.getMaMS(),
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        MauSac_VM mauSac_VM = this.data();
        int them = this.mauSacServive.xoaTT(mauSac_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
        }
        frameGOc.loadComBoBoxMS();
        loadTable();
        loadTableDelete();
        clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        MauSac_VM mauSac_VM = this.data();
        int them = this.mauSacServive.sua(mauSac_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MauSac_VM mauSac_VM = this.data();
        int them = this.mauSacServive.them(mauSac_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void tbl1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl1MouseClicked
        ...
        String id = null;
        List<MauSac_VM> list = this.mauSacServive.getAllDelete();
        for (MauSac_VM mauSac_VM2 : list) {
            if (mauSac_VM2.getMaMS().equals(ma)) {
                id = mauSac_VM2.getIdMS();
            }
        }
        MauSac_VM mauSac_VM1 = new MauSac_VM(WIDTH, id, ma, ten);
        this.setMauSac_VM(mauSac_VM1);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int them = this.mauSacServive.hoanLai(this.getMauSac_VM());
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int them = this.mauSacServive.xoa(this.getMauSac_VM());
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private MauSac_VM data() {
        String id = null;
        String ma = this.ma.getText();
        String ten = this.ten.getText();
        List<MauSac_VM> list = this.mauSacServive.getAllMauSacs();
        for (MauSac_VM mauSac_VM : list) {
            if (mauSac_VM.getMaMS().equals(ma)) {
                id = mauSac_VM.getIdMS();
            }
        }
        MauSac_VM mauSac_VM1 = new MauSac_VM(WIDTH, id, ma, ten);
        return mauSac_VM1;
