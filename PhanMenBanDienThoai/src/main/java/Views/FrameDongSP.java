...
import Repository.impl.DongSPRepo;
...
public class FrameDongSP extends javax.swing.JFrame {
    ...
    public void setDongSP(DongSP_VM dongSP) {
        this.dongSP = dongSP;
    }

    private FrameQuanLySanPham frameGOc;

    public FrameDongSP(FrameQuanLySanPham quanLySanPham) {
        initComponents();
    ...
    private void loadTable() {
        ...
        for (DongSP_VM dongSP_VM : list) {
            Object[] row = {
                dongSP_VM.getStt(),
                dongSP_VM.getMaDongSP(),
                dongSP_VM.getTenDongSP(),};
            dtm.addRow(row);
        }
    }
    ...
    private void loadTableDelete() {
        ...
        dtm.setRowCount(0);
        List<DongSP_VM> list = this.dongSPServive.getAllDelete();
        for (DongSP_VM dongSP_VM : list) {
            Object[] row = {
                dongSP_VM.getStt(),
                dongSP_VM.getMaDongSP(),
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        DongSP_VM dongSP_VM1= this.data();
        int them = this.dongSPServive.xoaTT(dongSP_VM1);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
        }
        frameGOc.loadComBoBoxdong();
        loadTable();
        loadTableDelete();
        clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DongSP_VM dongSP_VM = this.data();
        int them = this.dongSPServive.sua(dongSP_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DongSP_VM dongSP_VM = this.data();
        int them = this.dongSPServive.them(dongSP_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void tblxoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblxoaMouseClicked
        ...
        List<DongSP_VM> list = this.dongSPServive.getAllDelete();
        for (DongSP_VM dongSP_VM : list) {
            if (dongSP_VM.getMaDongSP().equals(ma)) {
                id = dongSP_VM.getIdDongSP();
            }
        }
       DongSP_VM dongSP_VM = new DongSP_VM(0, id, ma, ten);
        this.setDongSP(dongSP_VM);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        DongSP_VM dongSP_VM = this.getDongSP();
        int them = this.dongSPServive.hoanLai(dongSP_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int them = this.dongSPServive.xoa(this.getDongSP());
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private DongSP_VM data() {
        ...
        DongSP_VM dongSP_VM = new DongSP_VM(WIDTH, id, ma, ten);
        return dongSP_VM;
    }
