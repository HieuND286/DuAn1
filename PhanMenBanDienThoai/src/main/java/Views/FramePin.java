...
import Repository.impl.PinRepo;
...
public class FramePin extends javax.swing.JFrame {
    ...
    private Pin_VM pin_VM;

    private FramePin() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public Pin_VM getPin_VM() {
        return pin_VM;
    }

    public void setPin_VM(Pin_VM pin_VM) {
        this.pin_VM = pin_VM;
    }
    ...
    public FramePin(FrameQuanLySanPham quanLySanPham) {
        initComponents();
    ...
    private void loadTableDelete() {
        ...
        dtm.setRowCount(0);
        List<Pin_VM> list = this.pinServive.getAllDelete();
        for (Pin_VM pin_VM : list) {
            Object[] row = {
                pin_VM.getStt(),
                pin_VM.getMaPin(),
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        Pin_VM pin_VM = this.data();
        int them = this.pinServive.xoaTT(pin_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
        }
        frameGOc.loadComBoBoxPin();
        loadTable();
        loadTableDelete();
        clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Pin_VM pin_VM = this.data();
        int them = this.pinServive.sua(pin_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Pin_VM pin_VM = this.data();
        int them = this.pinServive.them(pin_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void tblxoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblxoaMouseClicked
        ...
        String id = null;
        List<Pin_VM> list = this.pinServive.getAllDelete();
        for (Pin_VM rom_VM : list) {
            if (rom_VM.getMaPin().equals(ma)) {
                id = rom_VM.getIdPin();
            }
        }

        Pin_VM pin_VM1 = new Pin_VM(row, id, ma, id);
        this.setPin_VM(pin_VM1);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int them = this.pinServive.hoanLai(this.pin_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        Pin_VM pin_VM = this.getPin_VM();
        int them = this.pinServive.xoa(pin_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private Pin_VM data() {
        ...
        List<Pin_VM> list = this.pinServive.getAllPin();
        for (Pin_VM pin_VM : list) {
            if (pin_VM.getMaPin().equals(ma)) {
                id = pin_VM.getIdPin();
            }
        }
        Pin_VM pin_VM = new Pin_VM(WIDTH, id, ma, ten);
        return pin_VM;
    }
