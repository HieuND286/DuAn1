 ...
 * @author admin
 */
public class FrameDotKhuyenMai extends javax.swing.JPanel {
    ...
    public FrameDotKhuyenMai(ManHinhChinh manHinhChinh) {
        initComponents();
    ...
    public void loadTableSanPham() {
        ...
        dtm.setRowCount(0);
        List<SanPham_VM> listsp = sanPhamService.getAllSanPhams();
