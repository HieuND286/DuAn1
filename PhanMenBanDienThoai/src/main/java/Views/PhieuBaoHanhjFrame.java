 ...
 * @author DELL
 */
public class PhieuBaoHanhjFrame extends javax.swing.JFrame {

    private PhieuBaoHanhService PBH = new PhieuBaoHanhService();
    private GoiBaoHanhService GBH = new GoiBaoHanhService();

    /**
     * Creates new form PhieuBaoHanh
     */
    public PhieuBaoHanhjFrame() {
        initComponents();
        LoadTablePBH();
        Loadcbb();
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhieuBaoHanhjFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhieuBaoHanhjFrame().setVisible(true);
            }
        });
    }
