...
public class FrameRom extends javax.swing.JFrame {
    ...
    private Rom_VM rom_VM1;

    private FrameRom() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public Rom_VM getRom_VM1() {
        return rom_VM1;
    }

    public void setRom_VM1(Rom_VM rom_VM1) {
        this.rom_VM1 = rom_VM1;
    }

    private FrameQuanLySanPham frameGOc;

    public FrameRom(FrameQuanLySanPham quanLySanPham) {
        initComponents();
    ...
    private void loadTable() {
        ...
        for (Rom_VM rom_VM : list) {
            Object[] row = {
                rom_VM.getStt(),
                rom_VM.getMaRom(),
                rom_VM.getDungLuongRom(),};
            dtm.addRow(row);
        }
    }
    ...
    private void loadTableDelete() {
        ...
        dtm.setRowCount(0);
        List<Rom_VM> list = this.romServive.getAllDelete();
        for (Rom_VM rom_VM : list) {
            Object[] row = {
                rom_VM.getStt(),
                rom_VM.getMaRom(),
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        Rom_VM rom_VM = this.data();
        int them = this.romServive.xoaTT(rom_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
        }
        frameGOc.loadComBoBoxRom();
        loadTable();
        loadTableDelete();
        clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Rom_VM rom_VM = this.data();
        int them = this.romServive.sua(rom_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Rom_VM rom_VM = this.data();
        int them = this.romServive.them(rom_VM);
        if (them != 0) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
    ...
    private void tblxoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblxoaMouseClicked
        ...
        List<Rom_VM> list = this.romServive.getAllDelete();
        for (Rom_VM rom_VM : list) {
            if (rom_VM.getMaRom().equals(ma)) {
                id = rom_VM.getIdRom();
            }
        }

        Rom_VM rom_VM = new Rom_VM(0, id, ma, ten);
        this.setRom_VM1(rom_VM);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int them = this.romServive.hoanLai(this.getRom_VM1());
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        Rom_VM rom_VM = this.getRom_VM1();
        int them = this.romServive.xoa(rom_VM);
        if (them == 1) {
            JOptionPane.showMessageDialog(this, "Thành Công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất Bại");
    ...
    private Rom_VM data() {
        ...
        Rom_VM rom_VM = new Rom_VM(WIDTH, id, ma, ten);
        return rom_VM;
    }
