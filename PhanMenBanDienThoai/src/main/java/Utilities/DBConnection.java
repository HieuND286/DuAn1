...
public class DBConnection {//Lớp này giải quyết kết nối xử lý truy vấn
    ...
    private static String acc = "sa"; //điền username mssql của mọi người//
    private static String pass = "1"; //điền password mssql của mọi người//
    private static String dbName = "DU_AN_1";
    private static String connectionSql
            = "jdbc:sqlserver://" + hostName + ":1433;database=" + dbName + ";encrypt=true;trustServerCertificate=true";
